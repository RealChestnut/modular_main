...
static double mass = 2.715;//1.992;//(Kg)
double initial_z = 0;
	...
	//Loading gains from the "t3_mav_controller.launch" file
		...
		//Tilt Flight Mode Control Gains
			...
			//Motor PWM changer
                        ...
                        PWM_0=nh.param<double>("PWM_0_cal",1000);
                        PWM_1=nh.param<double>("PWM_1_cal",1000);
                        PWM_2=nh.param<double>("PWM_2_cal",1000);
                        PWM_3=nh.param<double>("PWM_3_cal",1000);
                        PWM_4=nh.param<double>("PWM_4_cal",1000);
                        PWM_5=nh.param<double>("PWM_5_cal",1000);
                        PWM_6=nh.param<double>("PWM_6_cal",1000);
                        PWM_7=nh.param<double>("PWM_7_cal",1000);
	//----------------------------------------------------------
...
void pwm_Arm(){
	PWMs_cmd.data.resize(8);
	PWMs_cmd.data[0] = PWM_0;
	PWMs_cmd.data[1] = PWM_1;
	PWMs_cmd.data[2] = PWM_2;
	PWMs_cmd.data[3] = PWM_3;
	PWMs_cmd.data[4] = PWM_4;
	PWMs_cmd.data[5] = PWM_5;
	PWMs_cmd.data[6] = PWM_6;
	PWMs_cmd.data[7] = PWM_7;
	PWMs_val.data.resize(16);
	PWMs_val.data[0] = pwmMapping(PWM_0);
	PWMs_val.data[1] = pwmMapping(PWM_1);
	PWMs_val.data[2] = pwmMapping(PWM_2);
	PWMs_val.data[3] = pwmMapping(PWM_3);
	PWMs_val.data[4] = pwmMapping(PWM_4);
